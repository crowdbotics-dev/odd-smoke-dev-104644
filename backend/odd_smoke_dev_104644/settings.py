"""
Django settings for odd_smoke_dev_104644 project.
...
ROOT_URLCONF = 'odd_smoke_dev_104644.urls'
...
WSGI_APPLICATION = 'odd_smoke_dev_104644.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_smoke_dev_104644 API",
    "DESCRIPTION": "API documentation for odd_smoke_dev_104644 App",
    "VERSION": "v1",
}
